...
namespace CompositePersistente.DAL
{
    public class AccesoSqlServer
    {
        ...
        readonly string CadenaC = @"Data Source=(LocalDB)\MSSQLLocalDB;Initial Catalog=upf;Integrated Security=True";

        //private SqlConnection oCnn = new SqlConnection(@"Data Source=.\SQLEXPRESS02;Initial Catalog=upf;Integrated Security=True");
        readonly SqlConnection oCnn = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;Initial Catalog=upf;Integrated Security=True");
