...
namespace BE
{
    public class Pago_Estadia : Entity
    {
        ...
        private Factura_Hospedaje facturaHospedaje;

        public Factura_Hospedaje FacturaHospedaje
        {
            get { return facturaHospedaje; }
            set { facturaHospedaje = value; }
        }
